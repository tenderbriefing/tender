...
# Fail-closed: Founder SME Outreach UI off unless explicitly enabled at build time.
ARG NEXT_PUBLIC_FOUNDER_SME_OUTREACH_ENABLED=false
...
ENV NEXT_PUBLIC_FOUNDER_SME_OUTREACH_ENABLED=$NEXT_PUBLIC_FOUNDER_SME_OUTREACH_ENABLED
